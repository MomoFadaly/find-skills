...
```bash
git clone https://github.com/MomoFadaly/find-skills.git
```

Or download the zip from [fadaly.net/skills/find-skills](https://fadaly.net/skills/find-skills) (the per-skill landing page on fadaly.net) and extract into `~/.claude/skills/`.
